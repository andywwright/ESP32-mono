/*
  ...
  frcs82.c - Mitsubishi FR-CS82S VFD spindle support
...
static void onReportOptions (bool newopt)
{
    ...
    if(!newopt)
        report_plugin("FR-CS82S VFD", "0.05");
}
...
void vfd_frcs82_init (void)
{
    ...
    if((spindle_id = vfd_register(&vfd, "FR-CS82S")) != -1) {
